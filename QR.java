public class QRMethod {
    ...
    /* Definição dos paramentros*/
        ...
        /* Multiplicacao da matriz pela sua transposta*/
        ...
        static void MatrizRotacao(double u[][], double a[][], int i, int j)  {
                for (int p = 0; p < MAX; p++) {
                        for (int q = 0; q < MAX; q++) {
                                if (p == q)
                                        u[p][q] = 1;
            ...
            /*temp recebe o primeiro elemento abaixo da diagonal principal*/
                ...
                for (int i = 1; i < MAX; i++) {
                        for (int j = 0; j < MAX; j++) {       
                                ...
                                if (i == j)
                                        break;
                                /*Compara os valores absolutos abaixo da dp*/
        ...
        static double[][] ResolveA(double a[][]){
                QR QR;
